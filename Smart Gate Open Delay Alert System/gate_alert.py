...
def save_alert_image(frame):
    ...
    file_path = os.path.join(folder_path, f"{time_name}.jpg")
...
class DynamicGateAlertSystem:
    ...
    def select_rois(self, frame):
        ...
        print("Click LEFT gate (4 pts), then RIGHT gate (4 pts). Press 's' to save.")
    ...
    def run(self):
        ...
        while cap.isOpened():
            ...
            if any_open:
                ...
                partial_elapsed = current_time - self.partial_start
            ...
            if both_open:
                ...
                full_elapsed = current_time - self.full_start

                if full_elapsed >= FULL_TIME_THRESH:
                    new_state = "GATE FULL OPEN"
            ...
            if new_state != self.current_state:
                ...
                self.trigger_alert(self.current_state)
            ...
            cv2.imshow("Gate Alert System", frame)
